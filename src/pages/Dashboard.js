...
{menudata.map(el=><div className='menu'>
 ...
 </div></div>:(etat=="Orders")?<div><h2 >Orders</h2><div style={{minHeight: '100vh',minWidth:'80vw',display:'flex',flexWrap:'wrap',justifyContent:'space-around'}}>
 {orderdata.map(el=>
<div className='order' style={{display:'flex', flexWrap:'wrap',maxWidth:'35vw'}}>
